...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    longDescription: 'Clean air is the foundation of a clear mind. Nami Essence uses a moss-based bio-filter combined with HEPA technology to scrub pollutants from your home. It gently diffuses natural essential oils—cedar, bergamot, and rain—orchestrated to match the time of day.',
    price: 599,
    category: 'Home',
  ...
  },
  {
    ...
    longDescription: 'Artificial light disrupts our natural rhythms. Nami Beam syncs with your local sunrise and sunset, providing cool, energizing light during the day and transitioning to a warm, amber glow free of blue light in the evening. Controls are touchless; a simple wave of the hand adjusts brightness.',
    price: 249,
    category: 'Home',
  ...
  },
  {
    ...
    description: 'A digital stylus with the friction of graphite. Charges wirelessly when magnetically attached to Nami Canvas.',
    longDescription: 'The connection between hand and brain is sacred. Nami Scribe features a custom elastomer tip that replicates the microscopic friction of graphite on paper. Weighted perfectly for balance, it disappears in your hand, leaving only your thoughts.',
    price: 129,
    category: 'Mobile',
...
export const JOURNAL_ARTICLES: JournalArticle[] = [
    {
        ...
        content: React.createElement(React.Fragment, null,
            ...
            React.createElement("p", { className: "mb-6 text-[#5D5A53]" },
                "At Nami, we design for the hand as much as for the eye. We choose materials that have a voice. Sandstone that warms under your palm. Fabric that has a weave you can trace. Wood that remembers the forest."
            )
        )
    },
    {
